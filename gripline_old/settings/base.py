"""
Django settings for gripline project.
...
WSGI_APPLICATION = "gripline.wsgi.application"
...
EMAIL_HOST_PASSWORD = '5a33af98b71f93708a4179b652a6baeb'  # пароль приложения
DEFAULT_FROM_EMAIL = 'gripline.ru@yandex.ru'
SERVER_EMAIL = 'gripline.ru@yandex.ru'  # Это тоже стоит добавить
