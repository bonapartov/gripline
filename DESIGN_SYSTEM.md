...
| `--gl-signal-green` | `#28a745` | **НЕ брендовый** — только смысловые состояния: рост, результат выше среднего, «зелёный свет» |
| `--gl-signal-success` | `var(--gl-signal-green)` | Успех, рост, положительные показатели |
