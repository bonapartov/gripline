...
urlpatterns = [
    ...
    path('ads/<int:ad_id>/', views.ads_detail, name='ads_detail'),
    path('ads/create/', views.ads_create, name='ads_create'),
    path('ads/<int:ad_id>/respond/', views.ads_respond, name='ads_respond'),
    path("ads/<int:ad_id>/edit/", views.ads_edit, name="ads_edit"),
    path("ads/<int:ad_id>/delete/", views.ads_delete, name="ads_delete"),
